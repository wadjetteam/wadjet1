...
import ExaminationTracker from './ExaminationTracker'

const TABS = [
  { id: 'calendar', label: 'Regulatory Calendar' },
  { id: 'exams', label: 'Examination Tracker' },
]

export default function CBEDeadlinesHub() {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-6 scrollbar-thin">
      ...
      {activeTab === 'calendar' && <RegulatoryCalendar />}
      {activeTab === 'exams' && <ExaminationTracker />}
    </div>
  )
}
