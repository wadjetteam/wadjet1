...
const TABS = [
  ...
  { id: 'cro', label: 'CRO Dashboard' },
]

export default function UnifiedDashboards({ auditorMode }) {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-6 scrollbar-thin">
      ...
      {activeTab === 'executive' && <Dashboard auditorMode={auditorMode} />}
      {activeTab === 'board' && <ExecutiveDashboard />}
      {activeTab === 'cro' && <CRODashboard />}
    </div>
  )
}
