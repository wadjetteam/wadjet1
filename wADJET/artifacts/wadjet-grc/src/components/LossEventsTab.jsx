...
const PALETTE = ['#c41e3a','#b8860b','#d4af37','#4f7da6','#2d7d46','#7a9fbf','#c9a82e','#8b4513','#4682b4','#6b8e23']
const SEV_PALETTE = { critical: '#c41e3a', high: '#b8860b', medium: '#d4af37', low: '#2d7d46' }
const STAT_PALETTE = { open: '#c41e3a', remediated: '#2d7d46', closed: '#4f7da6' }
...
function SkeletonBar({ w }) { return <div className="h-3 rounded animate-pulse" style={{ width: w || '100%', background: 'rgba(212,175,55,0.08)' }} /> }
    ...
    <div className="pharaoh-card p-5 space-y-4">
      ...
      <div className="flex items-end gap-2 h-[180px] pt-4">
        {[75, 45, 90, 30, 60, 85, 40, 70].map((h, i) => (
          <div key={i} className="flex-1 rounded-t animate-pulse" style={{ height: `${h}%`, background: 'rgba(212,175,55,0.06)' }} />
        ))}
      </div>
    </div>
  )
...
function TableSkeleton() {
  return (
    <div className="pharaoh-card p-5 space-y-3">
      <div className="flex gap-4 pb-2" style={{ borderBottom: '1px solid rgba(212,175,55,0.08)' }}>
...
function CascadeMeta({ event }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 mt-3 pt-3" style={{ borderTop: '1px solid rgba(212,175,55,0.08)' }}>
      <div>
    ...
    <div className="h-full overflow-y-auto p-6 space-y-6 scrollbar-thin">
      ...
      <div className="grid grid-cols-4 gap-3 animate-fade-in">
        <div className="pharaoh-card p-4">
          ...
          <p className="text-xl font-bold" style={{ color: '#c41e3a' }}>{fmtM(totalGross)}</p>
        ...
        <div className="pharaoh-card p-4">
          ...
          <p className="text-xl font-bold" style={{ color: '#b8860b' }}>{fmtM(totalNet)}</p>
        ...
        <div className="pharaoh-card p-4">
          ...
          <p className="text-xl font-bold" style={{ color: recoveryRate >= 10 ? '#2d7d46' : '#d4af37' }}>{recoveryRate.toFixed(1)}%</p>
        ...
        <div className="pharaoh-card p-4">
          ...
          <p className="text-xl font-bold" style={{ color: unresolvedCount > 0 ? '#c41e3a' : '#2d7d46' }}>{unresolvedCount}</p>
            ...
            <div className="pharaoh-card p-5">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <LineChart data={monthlyLoss}>
                  ...
                  <Line type="monotone" dataKey="actual" name="Gross Loss (M EGP)" stroke="#c41e3a" strokeWidth={2} dot={{ fill: '#c41e3a', r: 3 }} activeDot={{ r: 5 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            <div className="pharaoh-card p-5">
                      ...
                      <div className="flex items-center gap-1.5">
                        {event.status === 'open' ? (
                          <span className="relative flex items-center gap-1.5 text-[10px] px-2 py-0.5 rounded-full capitalize" style={{ background: `${STAT_PALETTE.open}20`, color: STAT_PALETTE.open }}>
                            <span className="absolute w-1.5 h-1.5 rounded-full bg-[#c41e3a] animate-ping opacity-75" />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <input type="text" value={form.title} onChange={e => adjustForm('title', e.target.value)}
                  ...
                  style={{ background: 'rgba(212,175,55,0.05)', border: `1px solid ${fieldErrors.title ? 'rgba(239,68,68,0.3)' : 'rgba(212,175,55,0.15)'}` }} />
              ...
              <div>
                ...
                <input type="number" value={form.grossLoss} onChange={e => adjustForm('grossLoss', e.target.value)}
                  ...
                  style={{ background: 'rgba(212,175,55,0.05)', border: `1px solid ${fieldErrors.grossLoss ? 'rgba(239,68,68,0.3)' : 'rgba(212,175,55,0.15)'}` }} />
              ...
              <div>
                ...
                <input type="number" value={form.netLoss} onChange={e => adjustForm('netLoss', e.target.value)}
                  ...
                  style={{ background: 'rgba(212,175,55,0.05)', border: `1px solid ${fieldErrors.netLoss ? 'rgba(239,68,68,0.3)' : 'rgba(212,175,55,0.15)'}` }} />
              ...
              <div>
                ...
                <input type="date" value={form.dateOccurred} onChange={e => adjustForm('dateOccurred', e.target.value)}
                  ...
                  style={{ background: 'rgba(212,175,55,0.05)', border: `1px solid ${fieldErrors.dateOccurred ? 'rgba(239,68,68,0.3)' : 'rgba(212,175,55,0.15)'}` }} />
              ...
              <div>
                ...
                <input type="date" value={form.dateDetected} onChange={e => adjustForm('dateDetected', e.target.value)}
                  ...
                  style={{ background: 'rgba(212,175,55,0.05)', border: `1px solid ${fieldErrors.dateDetected ? 'rgba(239,68,68,0.3)' : 'rgba(212,175,55,0.15)'}` }} />
              ...
              <div className="col-span-2">
                <div className="flex items-start gap-2 p-3 rounded-xl" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.1)' }}>
