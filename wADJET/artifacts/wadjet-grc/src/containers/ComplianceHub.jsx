...
const TABS = [
  { id: 'engine', label: 'Compliance Engine' },
  { id: 'gap', label: 'Gap Assessment' },
]

export default function ComplianceHub({ auditorMode }) {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-6 scrollbar-thin">
      ...
      {activeTab === 'engine' && <ComplianceEngine auditorMode={auditorMode} />}
      {activeTab === 'gap' && <GapAssessment />}
    </div>
  )
}
