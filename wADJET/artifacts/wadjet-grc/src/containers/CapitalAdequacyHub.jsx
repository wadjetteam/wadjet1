...
const TABS = [
  { id: 'basel', label: 'Basel III/IV Capital' },
  { id: 'reporting', label: 'Regulatory Reporting' },
]

export default function CapitalAdequacyHub() {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-6 scrollbar-thin">
      ...
      {activeTab === 'basel' && <BaselCapitalDashboard />}
      {activeTab === 'reporting' && <RegulatoryReporting />}
    </div>
  )
}
