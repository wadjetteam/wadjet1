          ...
          <div className="space-y-5">
            <div className="pharaoh-card p-5 text-center">
              ...
              <div className="w-full h-2 rounded-full bg-pharaoh-500/5 mt-3 overflow-hidden">
                <div className="h-full rounded-full transition-all duration-300" style={{ width: `${scrollProgress}%`, backgroundColor: scrollProgress >= 100 ? '#20c997' : '#d4a832' }} />
              </div>
      ...
      {activeTab === 'tracker' && (
        <div className="animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <div className="grid grid-cols-4 gap-4 mb-5">
            {[
              { label: t('Total Employees'), value: totalAll, color: '#d4a832' },
              { label: t('Attested'), value: totalCompleted, color: '#20c997' },
              { label: t('Overall Rate'), value: `${overallRate}%`, color: '#d4a832' },
              { label: t('Pending'), value: totalAll - totalCompleted, color: '#dc3545' },
            ].map(stat => (
                        ...
                        <td className="py-3 px-3 text-center">
                          <div className="flex items-center gap-2 justify-center">
                            <div className="w-16 h-1.5 rounded-full bg-pharaoh-500/5 overflow-hidden">
                              <div className="h-full rounded-full transition-all" style={{ width: `${rate}%`, backgroundColor: rate >= 90 ? '#20c997' : rate >= 70 ? '#d4a832' : '#dc3545' }} />
                            </div>
