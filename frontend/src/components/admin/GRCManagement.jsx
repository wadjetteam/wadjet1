        ...
        return (
          <div>
            ...
            <div className="grid grid-cols-4 gap-4 mb-5">
              {[
                { label: 'Total Endpoints', value: fleet.length, color: '#d4a832' },
                { label: 'Online Agents', value: onlineCount, color: '#20c997' },
                { label: 'Offline Agents', value: offlineCount, color: '#dc3545' },
                { label: 'Agent Coverage', value: `${Math.round((onlineCount / fleet.length) * 100)}%`, color: onlineCount / fleet.length >= 0.8 ? '#20c997' : '#d4a832' },
              ].map(stat => (
